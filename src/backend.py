...
class Backend:
    ...
    def __init__(self, radio=None, print_flag=0):
        ...
        self.radio = None
        self.annu = None
        if isinstance (radio, serialRadio) or isinstance (radio,ecalRadio) or isinstance(radio, ivyRadio):
    ...
    def attach_radio(self, radio):
        ...
        """
        if (isinstance (radio, serialRadio) or isinstance (radio,ecalRadio)or isinstance (radio,ivyRadio)) and self.radio is None:
            self.radio = radio
